...
class Models():
    ...
    def model(self, model_name: str, model_switch, xt, parameters: dict, poped_db):
        result = {}
        if model_name == "ff_PK_1_comp_oral_md_KE":
            result = self.ff_PK_1_comp_oral_md_KE(model_switch, xt, parameters, poped_db)
        
        elif model_name == "ff_PK_1_comp_oral_md_CL":
            result = self.ff_PK_1_comp_oral_md_CL(model_switch, xt, parameters, poped_db)

        elif model_name == "ff_PK_1_comp_oral_sd_KE":
            result = self.ff_PK_1_comp_oral_sd_KE(model_switch, xt, parameters, poped_db)

        elif model_name == "ff_PK_1_comp_oral_sd_CL":
            result = self.ff_PK_1_comp_oral_sd_CL(model_switch, xt, parameters, poped_db)

        elif model_name == "ff_PKPD_1_comp_sd_CL_emax":
            result = self.ff_PKPD_1_comp_sd_CL_emax(model_switch, xt, parameters, poped_db)

        elif model_name == "ff_PKPD_1_comp_oral_md_CL_imax":
            result = self.ff_PKPD_1_comp_oral_md_CL_imax(model_switch, xt, parameters, poped_db)
    ...
    def ff_PK_1_comp_oral_md_KE(self, model_switch, xt, parameters: dict, poped_db):
    ...
    ## 
    ## @export
    def ff_PK_1_comp_oral_md_CL(self, model_switch, xt, parameters: dict, poped_db):
        ##-- Model: One comp first order absorption
        ## -- Analytic solution for both mutiple and single dosing
        y = xt
        N = np.floor(xt/parameters["TAU"])+1
    ...
    def ff_PK_1_comp_oral_sd_KE(self, model_switch, xt, parameters: dict, poped_db):
        ##-- Model: One comp first order absorption
        y = xt
    ...
    ## 
    ## @export
    def ff_PK_1_comp_oral_sd_CL(self, model_switch, xt, parameters: dict, poped_db):
        ##-- Model: One comp first order absorption
        y = xt
    ...
    ## 
    ## @export
    def ff_PKPD_1_comp_sd_CL_emax(self, model_switch, xt, parameters: dict, poped_db):
        y = xt
        MS = model_switch
    ...
    ## 
    ## @export
    def ff_PKPD_1_comp_oral_md_CL_imax(self, model_switch, xt, parameters: dict, poped_db):
        ...
        returnArgs = self.ff_PK_1_comp_oral_md_CL(model_switch, xt, parameters, poped_db)
        CONC = returnArgs["y"]
    ...
    ## @example tests/testthat/examples_fcn_doc/examples_ff.PK.1.comp.oral.md.CL.R
    ## @export
    def feps_add_prop(self, model_switch, xt, parameters, epsi, poped_db):
    ...
    ## @export
    def feps_add(self, model_switch, xt, parameters, epsi, poped_db):
        ## -- Residual Error function
        ## -- Additive 
        returnArgs = feval(poped_db["model"]["ff_pointer"], model_switch, xt, parameters, poped_db) 
        y = returnArgs[0]
    ...
    ## 
    ## @export
    def feps_prop(self, model_switch, xt, parameters, epsi, poped_db):
        ## -- Residual Error function
        ## -- Proportional 
        returnArgs = feval(poped_db["model"]["ff_pointer"], model_switch, xt, parameters, poped_db) 
        y = returnArgs[0]
